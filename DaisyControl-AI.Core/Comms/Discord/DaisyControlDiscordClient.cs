...
namespace DaisyControl_AI.Core.Comms.Discord
{
    public class DaisyControlDiscordClient : IDaisyControlDiscordClient
    {
        ...
        bool isReady = false;// To know when the websocket is bound
        string discordBotToken = null;// Comes from the config. Represents the TOKEN related to the bot, this is an ID generated by Discord
            ...
            IDiscordBotUserMessageHandler discordBotUserMessageHandler)
        {
            ...
            discordBotToken = CommonConfigurationManager.ReloadConfig()?.DiscordBotConfiguration?.SecretToken;
        ...
        private async Task BindDiscordBot()
        {
            ...
            {
                LoggingManager.LogToFile("6eeb2aeb-30b5-43f6-b1cd-c2314611bbb4", $"Couldn't connect the Discord Bot to Discord Network. The Discord bot will be disabled until DaisyControl-AI server is restarted.");
                return;
            }
