...
{
    public class DaisyControlGetUsersOldestThoughtAboutRefreshTimeRequestExecutor : IMainRequestExecutor
    {
        private DaisyControlGetUsersWithOldestThoughtAboutRefreshTimeRequestDto daisyControlGetUserDto = null;
        private IUsersDal daisyControlDal = null;
        private object response = null;

        public DaisyControlGetUsersOldestThoughtAboutRefreshTimeRequestExecutor(
            IUsersDal daisyControlDal,
            DaisyControlGetUsersWithOldestThoughtAboutRefreshTimeRequestDto daisyControlGetUserDto)
        {
        ...
        public async Task<bool> ExecuteAsync()
        {
            ...
            var usersToProcess = await daisyControlDal.TryGetUsersWithOldestThoughtAboutRefreshTimeAsync(daisyControlGetUserDto.MaxNbUsersToFetch);
